...
import br.edu.utfpr.xstoremagno.bean.FornecedorFacade;
...
public class FornecedorController implements Serializable {
    ...
    @EJB
    private br.edu.utfpr.xstoremagno.bean.FornecedorFacade ejbFacade;
    ...
    public static class FornecedorControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Fornecedor) {
                ...
                return getStringKey(o.getIdfornecedor());
            } else {
